---
title: "Kindle越狱与KOReader安装全记录"
date: 2026-08-16
categories: [技术]
tags: [技术, kindle, 越狱, koreader, 笔记]
---
...
| 项目 | 设备 1 | 设备 2 |
| :--- | :--- | :--- |
| 型号 | Kindle 8 代 | Kindle 7 代基础款 |
| 年份 | 2016 | 2014 |
| 代号 | KT3 (tinker) | KT2 |
| 固件 | 5.16.2.1.1 | 5.12.2.2 |
| 结果 | 越狱 + KOReader + 全套插件 | 越狱 + KOReader + 全套插件 |

两台设备均使用 **LanguageBreak** 越狱（适用于固件 ≤ 5.16.2.1.1 的所有 Kindle），原理是利用 langpicker-nativebridge 漏洞，无需拆机、无需焊接。
